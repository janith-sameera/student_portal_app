    ...
    <div class="content-wrapper">
        ...
        <div class="card card-primary">
            ...
            <script>
                ...
                if(exist){
                    swal("Done","Successfully Saved Subject !","success");
                }
            </script>
            <form role="form" method="post" action="save_class">
                {{csrf_field()}}
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">First Name</label>
                        <input type="text" class="form-control" name="classes" value="{{ old('classes') }}" placeholder="Enter Subjects">
                    </div>
                </div>
                <!-- /.card-body -->
