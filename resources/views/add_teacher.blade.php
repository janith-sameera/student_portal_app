                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/add_teacher" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add Teacher</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="card card-primary">
            ...
            <script>
                ...
                if(exist){
                    swal("Done","Successfully Saved Teacher Details !","success");
                }
            </script>
            <form role="form" method="post" action="save_teacher">
                {{csrf_field()}}
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contact_no" id="contact" onkeypress="return isNumber(event)" placeholder="Enter Contact Number" value="{{ old('contact_no') }}">
                    </div>
                    <div class="form-group">
